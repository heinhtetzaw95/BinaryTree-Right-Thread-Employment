...
//*                                                                                                   *
//*   PROGRAM FILE NAME: tree_right.cpp              ASSIGNMENT #: 8               Grade: _________   *
//*                                                                                                   *
//*   PROGRAM AUTHOR:     _________________________________________                                   *
//*                                    Hein Htet Zaw                                                  *
//*                                                                                                   *
//*   COURSE #:  CSC 36000 11                                                  DUE DATE: May 6, 2016  *
//*                                                                                                   *
//*****************************************************************************************************
//*****************************************************************************************************
//*                                                                                                   *
//*  Program description: This program works exactly the same as program 7, but this program employs  *
//*                       right-threads to build and traverse the Binary Tree using InOrder Traversal *
//*                       Data file name will be thread_in.txt and the output should be the same      *
//*                       format as Program 7.                                                        *
//*                                                                                                   *
//*****************************************************************************************************
#include <iostream>
